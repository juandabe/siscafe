 ...
 * @author jecheverri
 */
public class TypeUnitsView extends javax.swing.JInternalFrame {

    /**
     * Creates new form UserIFB
     */
    public TypeUnitsView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Gestión de tipo unidad de Café");
        ...
        jTextField2.setText("Buscar Tipo  Unidad...");
        ...
        jLabel2.setText("Nombre tipo unidad:");

        jLabel1.setText("Producto:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cafe", "Cacao" }));
